...
class AddEditActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            DataManager.loadData(this@AddEditActivity)
        }
        ...
        btnSave.setOnClickListener {
            ...
            lifecycleScope.launch {
                if (existingRestaurant != null) {
                    DataManager.updateRestaurant(this@AddEditActivity, existingRestaurant.name, newRestaurant)
                    Toast.makeText(this@AddEditActivity, "Restaurant Updated!", Toast.LENGTH_SHORT).show()
                } else {
                    DataManager.addRestaurant(this@AddEditActivity, newRestaurant)
                    Toast.makeText(this@AddEditActivity, "Added to Wishlist!", Toast.LENGTH_SHORT).show()
                }
                finish()
            }
        }
