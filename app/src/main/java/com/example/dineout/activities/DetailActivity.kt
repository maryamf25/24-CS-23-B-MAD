...
class DetailActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            DataManager.loadData(this@DetailActivity)
        }
        ...
        btnOptions.setOnClickListener { view ->
            ...
            popup.setOnMenuItemClickListener { item ->
                when (item.itemId) {
                    ...
                    R.id.action_delete -> {
                        lifecycleScope.launch {
                            DataManager.deleteRestaurant(this@DetailActivity, restaurant.name)
                            Toast.makeText(this@DetailActivity, "Restaurant Deleted!", Toast.LENGTH_SHORT).show()
                            finish()
                        }
                        true
                    }
    ...
    private fun showReviewDialog(name: String) {
        ...
        btnSubmit.setOnClickListener {
            ...
            lifecycleScope.launch {
                DataManager.markAsVisited(this@DetailActivity, name, rating, notes, spendValue, worthValue)

                Toast.makeText(this@DetailActivity, "Added to Visited!", Toast.LENGTH_SHORT).show()
                dialog.dismiss()
                finish()
            }
        }
